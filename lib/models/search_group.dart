...
//       status: json['status'] ?? false, // Defaulting to false if null
//       code: json['code'] ?? 0, // Defaulting to 0 if null
//       groups: (json['groups'] as List?)
//               ?.map((group) => Groups.fromJson(group))
//               .toList() ??
//           [], // Handling null lists
//     );
//   }
...
//       profile:
//           (json['profile'] as List?)?.map((item) => item as String).toList() ??
//               [],
//       members: (json['members'] as List?)
//               ?.map((member) => Members.fromJson(member))
//               .toList() ??
//           [],
//     );
//   }
