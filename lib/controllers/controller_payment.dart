    ...
    try {
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          customerId: Get.find<ControllerHome>().user.value!.user.information.id.toString(),
          paymentIntentClientSecret: paymentIntent!['client_secret'],
          merchantDisplayName: Get.find<ControllerHome>().user.value!.user.information.name,
        ),
      );
